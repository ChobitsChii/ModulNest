...
Status: **2.0.0-rc.2 – Release Candidate**. Dieser Stand ist eine öffentliche Vorabversion; ModulNest 1.3.0 bleibt der empfohlene Stable-Release. Downloads findest du unter [GitHub Releases](https://github.com/ChobitsChii/ModulNest/releases).
