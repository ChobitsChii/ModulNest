...
CREATE TABLE IF NOT EXISTS users (
    ...
    module_management_columns TEXT NULL,
...
ALTER TABLE users
    ...
    ADD COLUMN IF NOT EXISTS admin_nav_layout VARCHAR(16) NOT NULL DEFAULT 'tabs',
    ADD COLUMN IF NOT EXISTS favorite_modules TEXT NULL,
    ADD COLUMN IF NOT EXISTS header_modules TEXT NULL,
    ADD COLUMN IF NOT EXISTS avatar_path VARCHAR(255) NULL,
    ADD COLUMN IF NOT EXISTS module_management_columns TEXT NULL,
